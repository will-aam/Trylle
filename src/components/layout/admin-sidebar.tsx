...
export function AdminSidebar({ isCollapsed, setCollapsed }: AdminSidebarProps) {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-40 flex flex-col border-r bg-background shadow-sm",
          // Transições: no mobile animamos translate; no desktop animamos width
          "transition-transform duration-300 md:transition-[width] md:duration-300",
          // Mobile: abrir/fechar com translate
          isCollapsed ? "-translate-x-full md:translate-x-0" : "translate-x-0",
          // Largura base no mobile (drawer)
          "w-64",
          // Larguras no desktop (colapsado vs expandido)
